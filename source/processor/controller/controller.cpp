...
void Controller::updateView() {
  ...
  Instruction loadStoreUnitReservationStationLoadQueueInstructions[loadStoreUnitReservationStationSize];
  model.getLoadStoreUnitReservationStationLoadQueueInstructions(loadStoreUnitReservationStationLoadQueueInstructions);
  int loadStoreUnitReservationStationLoadQueueReorderBufferIndexes[loadStoreUnitReservationStationSize];
  model.getLoadStoreUnitReservationStationLoadQueueReorderBufferIndexes(loadStoreUnitReservationStationLoadQueueReorderBufferIndexes);
  int loadStoreUnitReservationStationLoadQueueAges[loadStoreUnitReservationStationSize];
  model.getLoadStoreUnitReservationStationLoadQueueAges(loadStoreUnitReservationStationLoadQueueAges);
  Instruction loadStoreUnitReservationStationStoreQueueInstructions[loadStoreUnitReservationStationSize];
  model.getLoadStoreUnitReservationStationStoreQueueInstructions(loadStoreUnitReservationStationStoreQueueInstructions);
  int loadStoreUnitReservationStationStoreQueueReorderBufferIndexes[loadStoreUnitReservationStationSize];
  model.getLoadStoreUnitReservationStationStoreQueueReorderBufferIndexes(loadStoreUnitReservationStationStoreQueueReorderBufferIndexes);
  int loadStoreUnitReservationStationStoreQueueAges[loadStoreUnitReservationStationSize];
  model.getLoadStoreUnitReservationStationStoreQueueAges(loadStoreUnitReservationStationStoreQueueAges);
  view.drawLoadStoreUnitReservationStation(loadStoreUnitReservationStationLoadQueueInstructions, 
    loadStoreUnitReservationStationLoadQueueReorderBufferIndexes, loadStoreUnitReservationStationLoadQueueAges, 
    loadStoreUnitReservationStationStoreQueueInstructions, loadStoreUnitReservationStationStoreQueueReorderBufferIndexes,
    loadStoreUnitReservationStationStoreQueueAges);
